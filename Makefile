...
$(EXE): $(MAINO) 
	g++ $(MAINFLAGS) $(MAINO) $(GLOBALSO) $(ENTITYO) $(CHARACTERO) $(PLAYERO) $(FIGMENTO) $(BATTLEO) $(ABILITYO) $(CHARGEDO) -o $(EXE)
$(MAINO): $(ABILITYO) $(CHARGEDO) $(PLAYERO) $(FIGMENTO) $(BATTLEO) $(MAINCPP) 
...
$(FIGMENTO): $(GLOBALSO) $(CHARACTERO) $(FIGMENTCPP) $(FIGMENTH)
