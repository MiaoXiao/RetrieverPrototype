...
ILLUMINITECPP = $(SRCPATH)Illuminite.cpp
...
ILLUMINITEH = $(SRCPATH)Illuminite.h
...
ILLUMINITEO = $(OBJPATH)Illuminite.o
...
$(INFOO): $(ABILITYO) $(ITEMO) $(ILLUMINITEO) $(GLOBALSO) $(INFOCPP) $(INFOH)
	g++ $(CLASSFLAGS) $(INFOCPP) -o $(INFOO)
	
$(ILLUMINITEO): $(ITEMO) $(CHARACTERO) $(ILLUMINITECPP) $(ILLUMINITEH)
	g++ $(CLASSFLAGS) $(ILLUMINITECPP) -o $(ILLUMINITEO)
