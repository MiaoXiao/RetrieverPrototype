...
$(EXE): $(MAINO) 
	g++ $(MAINFLAGS) $(MAINO) $(GLOBALSO) $(ENTITYO) $(CHARACTERO) $(PLAYERO) $(FIGMENTO) $(BATTLEO) $(ABILITYO) $(ABILITYMANAGERO) -o $(EXE)
...
$(ABILITYMANAGERO): $(ABILITYO) $(GLOBALSO) $(ABILITYMANAGERCPP) $(ABILITYMANAGERH)
