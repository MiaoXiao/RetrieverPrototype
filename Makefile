...
$(EXE): $(MAINO) 
	g++ $(MAINFLAGS) $(MAINO) $(GLOBALSO) $(ENTITYO) $(CHARACTERO) $(PLAYERO) $(FIGMENTO) $(BATTLEO) $(ABILITYO) $(INFOO) -o $(EXE)
...
$(ITEMO): $(GLOBALSO) $(ENTITYO) $(ITEMCPP) $(ITEMH)
	g++ $(CLASSFLAGS) $(ITEMCPP) -o $(ITEMO)
	
$(INFOO): $(ABILITYO) $(ITEMO) $(GLOBALSO) $(INFOCPP) $(INFOH)
